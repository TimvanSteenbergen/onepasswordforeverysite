...
class UnknownSite extends AbstractForm {
    ...
    constructor() {
        ...
        let message = `I, Opfes, recognize this page as a ${(SiteService.getDomain(window.location.href))} login-form, but I have not helped you to login here before.</br>
 If you wish me to help you login to  ${(SiteService.getDomain(window.location.href))} as well, then: ` +
            `<ol>` +
