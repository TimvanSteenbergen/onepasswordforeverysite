...
document.addEventListener('DOMContentLoaded', function () {
     ...
     */
    function showTheLocallyStoredData(numOfSitesToShow = 999999) {
    ...
    document.getElementById('OPFES_LoginButton').addEventListener('click', function () {
        let ourPopup = document;
        let site = new Site(ourPopup.getElementById('OPFES_InputDomain').value, ourPopup.getElementById('OPFES_InputSalt').value, ourPopup.getElementById('OPFES_InputUserId').value, +ourPopup.getElementById('OPFES_InputSequenceNr').value, +ourPopup.getElementById('OPFES_SelectMaxPwdChars').value, new Date(Date.now()), '' //remark
        );
