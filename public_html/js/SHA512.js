...
function SHA512(str) {
    ...
    function str2binb(str) {
        ...
        for (var i_1 = 0; i_1 < len; i_1 += charSize) {
            bin[i_1 >> 5] |= (str.charCodeAt(i_1 / charSize) & mask) << (32 - charSize - (i_1 % 32));
        }
        return bin;
    }
    function binb2hex(binarray) {
        ...
        var srcByte;
        for (var i_2 = 0; i_2 < length; i_2 += 1) {
            srcByte = binarray[i_2 >> 2] >> ((3 - (i_2 % 4)) * 8);
    ...
    str = utf8_encode(str);
    var stringLength = str.length * charSize;
    str = str2binb(str);
