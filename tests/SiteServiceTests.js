...
(function runTests() {
    ...
    testSites.push(new Site('testdomain.com', 'demosalt', 'demo@testdomain.com', 1, 10, `/~@#%^()_+-=.:?!{}`));
    expectedPasswords.push('uNcAuBR_50');
    testSites.push(new Site('testdomain.com', 'demosalt', 'demo@testdomain.com', 1, 11, `/~@#%^()_+-=.:?!{}`));
    expectedPasswords.push('N=/HDadS=23');
    testSites.push(new Site('testdomain.com', 'demosalt', 'demo@testdomain.com', 1, 20, `/~@#%^()_+-=.:?!{}`));
    expectedPasswords.push('vuVn~(3r{MRcVhSEB_80');
    testSites.push(new Site('testdomain.com', 'demosalt', 'demo@testdomain.com', 1, 30, `/~@#%^()_+-=.:?!{}`));
    expectedPasswords.push('?vu!tu6-!%kNP3_?!:}%Ew_=K_0rsc');
    testSites.push(new Site('testdomain.com', 'demosalt', 'demo@testdomain.com', 1, 40, `/~@#%^()_+-=.:?!{}`));
    expectedPasswords.push('4p4~@g%tgAmdT+/gamA(MZ~EhNTHUB+K%e/F-5dr');
    testSites.push(new Site('testdomain.com', 'demosalt', 'demo@testdomain.com', 1, 50, `/~@#%^()_+-=.:?!{}`));
    expectedPasswords.push('V#/M=Gre#pbn^/SC^@?6-:(^PU!Bh02SM{F-p369fC6M)-8FpV');
    testSites.push(new Site('testdomain.com', 'demosalt', 'demo@testdomain.com', 1, 118, `/~@#%^()_+-=.:?!{}`));
    ...
    testSites.push(new Site('testdomain.com', 'demosalt', 'demo@testdomain.com', 1, 119, `/~@#%^()_+-=.:?!{}`));
    ...
    testSites.push(new Site('testdomain.com', 'demosalt', 'demo@testdomain.com', 1, 120, `/~@#%^()_+-=.:?!{}`));
